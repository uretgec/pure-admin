...
(function () {
    ...
    function PanelCollection(postfix) {
        this.buttonBar = doc.getElementById("button_code" + postfix);
        this.preview = doc.getElementById("preview_code" + postfix);
        this.input = doc.getElementById("editor_code" + postfix);
    };
